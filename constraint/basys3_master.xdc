...
#- Description:   Constraint file for Basys3
#---------------------------------------------------------------------------------
...
set_property PACKAGE_PIN T1 [get_ports {half_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {half_sw}]
	
set_property PACKAGE_PIN R2 [get_ports {cont_sw}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cont_sw}]
...
##Buttons
## center
set_property PACKAGE_PIN U18 [get_ports {push_btn[0]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {push_btn[0]}]
# up
set_property PACKAGE_PIN T18 [get_ports {push_btn[1]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {push_btn[1]}]
# left
set_property PACKAGE_PIN W19 [get_ports {push_btn[2]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {push_btn[2]}]
# right
set_property PACKAGE_PIN T17 [get_ports {push_btn[3]}]						
	set_property IOSTANDARD LVCMOS33 [get_ports {push_btn[3]}]
# down
set_property PACKAGE_PIN U17 [get_ports {push_btn[4]}]						
...
##Sch name = JA3
#set_property PACKAGE_PIN J2 [get_ports {trig_pulse_out}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {trig_pulse_out}]
##Sch name = JA4
...
##Sch name = JB3
#set_property PACKAGE_PIN B15 [get_ports {echo_pulse_in}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {echo_pulse_in}]
###Sch name = JB4
#set_property PACKAGE_PIN B16 [get_ports {trig_pulse_out}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {trig_pulse_out}]
##Sch name = JB7
